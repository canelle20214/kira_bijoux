defmodule KiraBijoux.Repo.Migrations.InsertUserAddress do
  ...
  def change do
    ...
    user5 = Repo.one(from u in User, select: u.id, where: u.mail == "kira-bijoux@gmail.com")
    Repo.insert_all(User.Address,
      ...
      %{user_id: user5, name: "Maison", recipient: "Mme Kira", first_line: "7 rue de la gare", second_line: "", post_code: "75008", town: "Paris", country: "France", inserted_at: NaiveDateTime.truncate(NaiveDateTime.utc_now(), :second), updated_at: NaiveDateTime.truncate(NaiveDateTime.utc_now(), :second)}
      ]
    )
  end
end
